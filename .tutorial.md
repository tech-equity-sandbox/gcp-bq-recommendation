...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-bq-recommendation.sh` on the terminal.
...
This asset enables you to explore movie recommendations in BigQuery ML.
